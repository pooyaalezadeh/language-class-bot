    ...
    for (const update of updates) {
      ...
      if (text === "/start") {
        if (!welcomedUsers.includes(chatId)) {
          ...
          saveWelcome();
          await send(chatId, `👋 به ربات آموزشگاه زبان سپید خوش آمدید

این ربات برای ارائه اطلاعات کلاس‌های زبان، ثبت‌نام، مشاوره آموزشی و پاسخگویی به سوالات زبان‌آموزان طراحی شده است.

شما می‌توانید درباره:
📚 دوره‌های زبان
📝 ثبت‌نام کلاس‌ها
🎯 تعیین سطح
👩‍🏫 اساتید
...
برای شروع، یکی از گزینه‌های منو را انتخاب کنید یا سوال خود را ارسال کنید. 😊`);
